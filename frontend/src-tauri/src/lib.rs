...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_update_speaker_color,
            api::api_delete_speaker,
            api::api_get_speaker_segment_counts,
            api::api_reassign_speaker,
            api::api_ensure_meeting_speakers,
            api::api_add_speaker,
            api::api_update_transcript_speakers_batch,
            api::api_identify_and_assign_speakers,
