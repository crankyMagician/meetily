          ...
          return (
            <label
              ...
              className={`flex items-start p-3 border rounded-lg transition-all ${
                currentBackend === backend.id
                  ...
                  : 'border-input hover:border-border bg-surface'
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-blue-600 focus:ring-blue-500 border-input"
              />
              <div className="ml-3 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  {currentBackend === backend.id && (
                    <span className="text-xs font-medium text-blue-600 bg-blue-100 dark:bg-blue-900 px-2 py-0.5 rounded">
                      Active
                    </span>
                  )}
                  {isCoreAudio && (
                    <span className="text-xs font-medium text-muted-foreground bg-surface-tertiary px-2 py-0.5 rounded">
                      Disabled
                    </span>
                  )}
                </div>
                <p className="mt-1 text-xs text-text-secondary">{backend.description}</p>
              </div>
            </label>
          );
        })}
