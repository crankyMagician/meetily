              ...
              <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {isAvailable && (
                      <>
                        ...
                        {selectedModel === model.name && (
                          <span className="px-2 py-0.5 text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-700 rounded">
                            Selected
                          </span>
                        )}
                      </>
                ...
                <div className="ml-4 flex items-center gap-2">
                  ...
                  {isAvailable && !modelIsDownloading && selectedModel !== model.name && (
                    <button
                      className="p-2 rounded hover:bg-surface-tertiary transition-colors text-muted-foreground hover:text-red-600"
                      onClick={(e) => {
                        e.stopPropagation();
                        deleteModel(model.name);
                      }}
