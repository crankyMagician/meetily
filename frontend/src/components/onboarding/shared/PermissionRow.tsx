  ...
  return (
    <div
      className={cn(
        ...
        isAuthorized ? 'border-foreground bg-surface-tertiary' : isDenied ? 'border-red-300 bg-red-50 dark:bg-red-950' : 'bg-surface border-neutral-200'
      )}
    >
      {/* Left side: Icon + Info */}
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div
          className={cn(
            ...
            isAuthorized ? 'bg-surface-hover' : isDenied ? 'bg-red-100 dark:bg-red-900' : 'bg-neutral-50'
          )}
        >
