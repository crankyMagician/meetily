...
export function OnboardingContainer({
  ...
  return (
    <div className="fixed inset-0 bg-surface-secondary flex items-center justify-center z-50 overflow-hidden">
      <div className={cn('w-full max-w-2xl h-full max-h-screen flex flex-col px-6 py-6', className)}>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    canGoPrevious && step !== 1
                      ? 'hover:bg-surface-secondary hover:shadow-md hover:scale-110 text-text-primary'
        ...
        <div className="mb-4 text-center space-y-3 flex-shrink-0">
          ...
          {description && (
            <p className="text-base text-text-secondary max-w-md mx-auto animate-fade-in-up delay-75">
              {description}
            </p>
          )}
        </div>
