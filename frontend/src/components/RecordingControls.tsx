              ...
              {showPlayback ? (
                <>
                  ...
                  <div className="flex items-center space-x-1 mx-2">
                    <div className="text-sm text-text-secondary min-w-[40px]">
                        ...
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isPausing || isResuming || isStopping
                              ? 'bg-surface-hover border-2 border-input text-text-placeholder'
                              : 'bg-surface border-2 border-input text-text-secondary hover:border-gray-400 hover:bg-surface-secondary'
                              } rounded-full transition-colors relative`}
                          >
                            {isPaused ? <Play size={16} /> : <Pause size={16} />}
                            {(isPausing || isResuming) && (
                              <div className="absolute -top-8 text-text-secondary font-medium text-xs">
