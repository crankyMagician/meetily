...
export const AISummary = ({ summary, status, error, onSummaryChange, onRegenerateSummary, meeting }: Props) => {
  ...
  const renderErrorState = () => (
    <div className="w-full p-4 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg">
      ...
      <p className="text-red-500 dark:text-red-400 text-xs mt-2">Please check your model configuration and API keys, or try again.</p>
    </div>
  );

  const renderLoadingState = () => (
    <div className="w-full p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 rounded-lg">
  ...
  if (!hasContent && status === 'completed') {
    return (
      <div className="w-full p-4 bg-surface-secondary border border-border rounded-lg text-center">
        <p className="text-text-secondary">No summary content available.</p>
  ...
  return (
    <div className="relative">
      ...
      {contextMenu.visible && selectedBlocks.length > 0 && (
        ...
        >
          <button
            className="w-full px-4 py-2 text-left hover:bg-surface-tertiary flex items-center space-x-2"
          ...
          <button
            className="w-full px-4 py-2 text-left hover:bg-surface-tertiary text-red-600 flex items-center space-x-2"
      ...
      {/* <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="p-2 hover:bg-surface-tertiary rounded disabled:opacity-50"
            title="Undo"
          >
            <svg
          ...
          <button
            ...
            className="px-2 py-1 text-sm bg-surface-tertiary hover:bg-surface-hover rounded-md flex items-center space-x-1"
          >
            <span>📋</span>
            <span>Copy</span>
          </button>
