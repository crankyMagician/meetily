      ...
      <div className="p-3">
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1">
            ...
            {/* Model Specs */}
            <div className="flex items-center space-x-4 text-sm text-text-secondary ml-9 mt-1.5">
                ...
                <AnimatePresence>
                  {isHovered && (
                    <motion.button
                      ...
                      className="text-text-placeholder hover:text-red-600 transition-colors p-1"
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-xs text-text-secondary hover:text-red-600 font-medium transition-colors px-2 py-1 rounded hover:bg-red-50"
