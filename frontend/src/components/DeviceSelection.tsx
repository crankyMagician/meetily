    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          ...
          <div className="h-10 bg-surface-hover rounded mb-3"></div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-surface-tertiary disabled:pointer-events-none disabled:opacity-50"
          >
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="mic-selection" className="text-sm font-medium text-text-primary">
              Microphone
            </Label>
          </div>
          <Select
          ...
          {showLevels && inputDevices.length > 0 && (
            <div className="space-y-2 pt-2 border-t border-border-subtle">
              <p className="text-xs text-text-secondary font-medium">Microphone Levels:</p>
              {inputDevices.map((device) => {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Speaker className="h-4 w-4 text-text-secondary" />
            <Label htmlFor="system-selection" className="text-sm font-medium text-text-primary">
              System Audio
            </Label>
          </div>
