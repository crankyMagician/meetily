    ...
    <div className={`bg-surface border border-border rounded-lg p-4 ${className}`}>
      ...
      <div className="grid grid-cols-4 gap-4 mb-4 text-sm">
        ...
        <div className="text-center">
          ...
          <div className="text-text-secondary">Processing</div>
        </div>
          ...
          {progress.chunks
            ...
            .map((chunk) => (
              ...
              >
                ...
                {chunk.text_preview && (
                  <div className="mt-1 text-text-primary text-xs truncate">
                    "{chunk.text_preview}"
                  </div>
                )}
...
export function ChunkProgressMini({ progress, className = '' }: { progress: ProcessingProgress; className?: string }) {
  ...
  return (
    <div className={`bg-surface-secondary border border-border rounded-lg p-3 ${className}`}>
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium text-text-primary">
          Processing
        </span>
