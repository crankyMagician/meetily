...
export default function AnalyticsDataModal({ isOpen, onClose, onConfirmDisable }: AnalyticsDataModalProps) {
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <ul className="text-sm text-text-primary space-y-1 ml-4">
  ...
  "had_fatal_error": "false"
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-4 p-6 border-t border-border bg-surface-secondary">
          <button
            onClick={onClose}
            className="px-4 py-2 text-text-primary bg-surface border border-input rounded-md hover:bg-surface-secondary transition-colors"
          >
