...
export default function SettingsPage() {
  ...
  return (
    <div className="h-screen bg-surface-secondary flex flex-col">
      {/* Fixed Header */}
      <div className="sticky top-0 z-10 bg-surface-secondary border-b border-border">
              ...
              {TABS.map((tab, index) => {
                ...
                return (
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 px-6 py-4 bg-transparent rounded-none border-0 data-[state=active]:bg-transparent data-[state=active]:text-blue-600 data-[state=active]:shadow-none text-text-secondary hover:text-foreground relative z-10"
                  >
